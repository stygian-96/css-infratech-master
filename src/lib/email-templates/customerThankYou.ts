interface CustomerThankYouProps {
  fullName: string;
  phone: string;
  email: string;
  budget: string;
														...
														<tr>
															<td class="pad" style="padding-bottom:20px;padding-left:10px;padding-right:10px;padding-top:5px;">
																<div style="color:#666666;direction:ltr;font-family:Open Sans, Helvetica Neue, Helvetica, Arial, sans-serif;font-size:14px;font-weight:400;letter-spacing:0px;line-height:1.2;text-align:center;mso-line-height-alt:17px;">
																	<p style="margin: 0;">Premium Villas | Lucknow</p>
																</div>
															</td>
														</tr>
													</table>
													...
													<table class="heading_block block-1" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td class="pad" style="padding-bottom:30px;padding-left:60px;padding-right:60px;padding-top:50px;text-align:center;width:100%;">
																<h1 style="margin: 0; color: #c89b66; direction: ltr; font-family: 'Playfair Display', Georgia, serif; font-size: 35px; font-weight: 400; letter-spacing: normal; line-height: 1.2; text-align: center; margin-top: 0; margin-bottom: 0; mso-line-height-alt: 42px;"><span style="word-break: break-word;">Thank You for Your Interest!</span></h1>
															</td>
														</tr>
													</table>
														...
														<tr>
															<td class="pad" style="padding-bottom:10px;padding-left:60px;padding-right:60px;padding-top:10px;text-align:center;width:100%;">
																<h2 style="margin: 0; color: #000000; direction: ltr; font-family: Open Sans, Helvetica Neue, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400; letter-spacing: normal; line-height: 1.5; text-align: center; margin-top: 0; margin-bottom: 0; mso-line-height-alt: 24px;">
																	<span style="word-break: break-word;">Dear <strong>${fullName}</strong>,<br><br>Thank you for expressing interest in <strong>CCS Infratech</strong> - Lucknow's fastest-selling premium villa project featuring luxurious 3 & 4 BHK villas.</span>
																</h2>
															</td>
														</tr>
													</table>
													...
													<table width="100%" border="0" cellpadding="20" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background: linear-gradient(135deg, #fff8f0, #fef5e7); border-left: 4px solid #c89b66; border-radius: 8px;">
														<tr>
															<td>
																...
																<p style="margin: 0; color: #333; font-size: 15px; line-height: 1.6; font-family: 'Open Sans', Arial, sans-serif;">Our sales team will contact you on your registered mobile number to discuss your requirements and answer all your questions.</p>
															</td>
														</tr>
													</table>
												</td>
											...
											<tr>
												<td class="column column-1" width="100%" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; vertical-align: top;">
													<table class="heading_block block-1" width="100%" border="0" cellpadding="10" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td class="pad">
																<h2 style="margin: 0; color: #c89b66; direction: ltr; font-family: Open Sans, Helvetica Neue, Helvetica, Arial, sans-serif; font-size: 20px; font-weight: 600; letter-spacing: normal; line-height: 1.2; text-align: left; margin-top: 0; margin-bottom: 0;"><span style="word-break: break-word;">Your Inquiry Details:</span></h2>
															</td>
														</tr>
													</table>
															...
															<td class="pad">
																<table style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-collapse: collapse; width: 100%; table-layout: fixed; background-color: #f9f9f9; font-family: Open Sans, Helvetica Neue, Helvetica, Arial, sans-serif; font-weight: 400; color: #333333; text-align: left; border-radius: 8px;" width="100%">
																	<tbody style="vertical-align: top; font-size: 14px; line-height: 1.5;">
																		<tr>
																			<td width="30%" style="padding: 12px; word-break: break-word; border-bottom: 1px solid #e0e0e0; font-weight: 600; color: #666;">Name:</td>
																			<td width="70%" style="padding: 12px; word-break: break-word; border-bottom: 1px solid #e0e0e0;">${fullName}</td>
																		</tr>
																		<tr>
																			<td width="30%" style="padding: 12px; word-break: break-word; border-bottom: 1px solid #e0e0e0; font-weight: 600; color: #666;">Phone:</td>
																			<td width="70%" style="padding: 12px; word-break: break-word; border-bottom: 1px solid #e0e0e0;">${phone}</td>
																		</tr>
																		<tr>
																			<td width="30%" style="padding: 12px; word-break: break-word; border-bottom: 1px solid #e0e0e0; font-weight: 600; color: #666;">Email:</td>
																			<td width="70%" style="padding: 12px; word-break: break-word; border-bottom: 1px solid #e0e0e0;">${email}</td>
																		</tr>
																		<tr>
																			<td width="30%" style="padding: 12px; word-break: break-word; font-weight: 600; color: #666;">Budget:</td>
																			<td width="70%" style="padding: 12px; word-break: break-word;">${budget}</td>
																		</tr>
																	</tbody>
																</table>
															</td>
														...
														<tr>
															<td class="pad">
																<div style="color:#ffffff;direction:ltr;font-family:Open Sans, Helvetica Neue, Helvetica, Arial, sans-serif;font-size:14px;font-weight:400;line-height:1.5;text-align:center;opacity:0.8;mso-line-height-alt:21px;">
																	<p style="margin: 0;">Premium Villas | Lucknow</p>
																	<p style="margin: 5px 0 0 0;">Inquiry submitted on: ${currentTime}</p>
																</div>
															</td>
														</tr>
													</table>
