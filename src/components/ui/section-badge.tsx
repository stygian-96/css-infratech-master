...
const SectionBadge = ({ title }: Props) => {
  return (
    <div className="px-2.5 py-1 rounded-full bg-[#e1d18a] flex items-center justify-center gap-2">
      ...
      <span className="text-lg font-medium text-black bg-clip-text bg-gradient-to-r from-primary to-orange-300">
        {title}
      </span>
    </div>
  );
